...
To configure {AMQ_BROKER} for a high availability {PRODUCT} clustered environment, see  https://access.redhat.com/documentation/en-us/red_hat_amq/{AMQ_BROKER_VERSION}/html-single/using_amq_broker[_Using AMQ Broker_].
