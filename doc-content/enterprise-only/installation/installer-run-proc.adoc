...
ifdef::PAM[]
. Under *Component Installation*, on the *Configure Runtime Environment* page, choose whether to perform the default installation or perform an advanced configuration.
+
...
+
. If you selected *Customize {KIE_SERVER} properties*, change any of the following, if desired:
+
