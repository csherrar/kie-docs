...
ifdef::PAM[]
. If you installed {KIE_SERVER}, the *Configure Runtime* step appears under *Component Installation*. On the *Configure Runtime Environment* page, choose whether to perform the default installation or perform an advanced configuration.
+
...
* Clear any {KIE_SERVER} server function you want to disable.
+
