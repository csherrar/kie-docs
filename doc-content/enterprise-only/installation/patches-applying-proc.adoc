...
IMPORTANT: To upgrade from {PRODUCT} 7.2 to {PRODUCT_VERSION}, first update to {PRODUCT} 7.2.1 (latest patch update) and then follow this procedure again to upgrade to {PRODUCT} {PRODUCT_VERSION}. Adjust the example upgrade versions provided in this section as needed.
