...
IMPORTANT: {PRODUCT} 7.8 only supports {EAP} 7.3. You must migrate {EAP} 7.2 to 7.3 before upgrading {PRODUCT} from 7.7 to 7.8. For more information about migrating {EAP} 7.2 to 7.3, see XXXXXX.
...
* {EAP} is migrated from 7.2 to 7.3. For more information about migrating {EAP} 7.2 to 7.3, see XXXXXX.
