...
====
. To set the start up strategy, in the *Startup Strategy* field, enter one of the following:
+
...
[NOTE]
====
Do not enable the Controller strategy in an environment with a high-availability Business Central.
====
