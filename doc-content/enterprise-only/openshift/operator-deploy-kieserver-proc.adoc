...
+
To use CORS with a custom configuration, select *Custom configuration* from the *CORS Filters configuration* and enter the relevant values for the CORS filters.
