...
* https://access.redhat.com/documentation/en-us/red_hat_process_automation_manager/7.2/html-single/installing_and_configuring_red_hat_process_automation_manager_on_red_hat_jboss_eap_7.2/roles-users-con/#roles-users-con[_Roles and users_]
...
* https://access.redhat.com/documentation/en-us/red_hat_process_automation_manager/7.2/html-single/managing_and_monitoring_process_server/index#ldap-login-domain-proc[_Defining LDAP login domain_]
