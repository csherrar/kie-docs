...
You can integrate a custom {PRODUCT} service with an infinispan cluster using the following configuration modes:
...
For more information about installing Infinispan Operator and setting up an Infinispan cluster, see the https://infinispan.org/docs/infinispan-operator/main/operator.html[Infinispan Operator 2.2 Guide].
...
. To enable Infinispan persistence, bind KogitoInfra with the {PRODUCT} Service by doing one of the following tasks:
+
