[id='business-central-system-properties-ref']
...
Use these properties to set the location and name for the {KIE_SERVER} Git directory.
...
Use these properties to set how to access the Git repository over HTTP.
...
Use these properties to set how to access the Git repository over HTTPS.
...
Use these properties to enable and configure the Git daemon.
...
Use these properties to enable and configure the Git SSH daemon.
...
Use these properties to configure how to connect to the {KIE_SERVER} nodes from the {CONTROLLER}.
...
Use these properties to configure Maven and other miscellaneous functions.
...
Use these properties to configure how to connect to the {CONTROLLER}.
...
Use these properties to configure JCEKS.
...
Use these properties to switch between {CENTRAL} and {KIE_SERVER} rendered forms.
