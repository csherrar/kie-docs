...
ifdef::PAM[]
//include::{enterprise-dir}/installation/persistance-config-proc.adoc[leveloffset=+1]
include::{enterprise-dir}/installation/troubleshooting-ref.adoc[leveloffset=+1]
endif::PAM[]
