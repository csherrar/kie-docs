...
= Custom tasks and work item handlers in BPMN models
ifdef::context[:parent-context: {context}]
// Context attribute is assembly specific and enables module reuse between assemblies.
:context: custom-tasks

// Purpose statement for the assembly
As a business rules developer, you can create custom tasks and work item handlers in BPMN models to execute custom code within your process flows and extend the operations available for use in {PRODUCT}. You can use custom tasks to develop operations that {PRODUCT} does not directly provide and include them in process diagrams. Custom tasks and work item handlers support {CENTRAL}, standalone editors, and VSCode. This chapter describes how to create, manage, and deploy custom tasks and work item handlers by using {CENTRAL}.
