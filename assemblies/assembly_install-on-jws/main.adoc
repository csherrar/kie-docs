...
* You have installed {JWS} {JWS_VERSION_LONG} or higher. For information about installing {JWS}, see the https://access.redhat.com/documentation/en-us/red_hat_jboss_web_server/5.0/html-single/installation_guide/index[_{JWS} Installation Guide_].
...
include::{enterprise-dir}/project-data/git-import-project.adoc[leveloffset=+1]
