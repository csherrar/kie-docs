...
[WARNING]
====
Red Hat Developer Studio is in maintenance mode. Therefore, Installing and setting up the development environment with Red Hat Developer Studio for {PRODUCT} {PRODUCT_VERSION} is deprecated.
====
