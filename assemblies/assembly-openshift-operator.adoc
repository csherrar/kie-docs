...
= Deploying an {PRODUCT} environment on {OPENSHIFT} {OPENSHIFT_VERSION_SHORT} using Operators
ifdef::context[:parent-context: {context}]
// Context attribute is assembly specific and enables module reuse between assemblies.
:context: openshift-operator

// Purpose statement for the assembly
As a system engineer, you can deploy an {PRODUCT} environment on {OPENSHIFT} {OPENSHIFT_VERSION_SHORT} to provide an infrastructure to develop or execute
ifdef::DM[]
services
endif::DM[]
ifdef::PAM[]
...
// [NOTE]
// ====
// For instructions about deploying an {PRODUCT} environment on {OPENSHIFT} {OPENSHIFT_VERSION_SHORT_OLD} using templates, see {URL_DEPLOYING_ON_OPENSHIFT}#assembly-openshift-templates[_{DEPLOYING_OPENSHIFT_TEMPLATES}_].
// ====
