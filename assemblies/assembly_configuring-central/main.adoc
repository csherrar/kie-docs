...
include::{enterprise-dir}/admin-and-config/custom-tasks-creating-work-item-handler-projects-proc.adoc[leveloffset=+2]

include::{enterprise-dir}/admin-and-config/custom-tasks-work-item-handler-project-customization-con.adoc[leveloffset=+2]

include::{enterprise-dir}/admin-and-config/custom-tasks-work-item-definitions-con.adoc[leveloffset=+2]

include::{enterprise-dir}/admin-and-config/custom-tasks-deploying-custom-tasks-proc.adoc[leveloffset=+2]

include::{enterprise-dir}/admin-and-config/custom-tasks-registering-custom-tasks-proc.adoc[leveloffset=+2]

include::{enterprise-dir}/admin-and-config/custom-tasks-placing-custom-tasks-proc.adoc[leveloffset=+2]
