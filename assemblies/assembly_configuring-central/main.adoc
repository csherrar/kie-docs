...
include::{enterprise-dir}/admin-and-config/kie-server-configuring-environment-mode-proc.adoc[leveloffset=+1]

include::{enterprise-dir}/admin-and-config/business-central-configuring-environment-mode-proc.adoc[leveloffset=+1]
