...
+
NOTE: If you are using {PRODUCT} 7.2 and you want to upgrade to {PRODUCT} {PRODUCT_VERSION}, see
ifdef::PAM[]
https://access.redhat.com/documentation/en-us/red_hat_process_automation_manager/7.2/html-single/patching_and_upgrading_red_hat_process_automation_manager_7.2/[Patching and upgrading {PRODUCT} 7.2]
endif::[]
ifdef::DM[]
https://access.redhat.com/documentation/en-us/red_hat_decision_manager/7.2/html-single/patching_and_upgrading_red_hat_decision_manager_7.2/[Patching and upgrading {PRODUCT} 7.2]
endif::[]
or follow the instructions in this document and adjust the example upgrade versions accordingly.
