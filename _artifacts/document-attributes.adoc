...
:COMMUNITY_VERSION: 7.11
:ENTERPRISE_VERSION_SHORT: 71
...
:INSTALLING_ON_JWS: Installing and configuring {PRODUCT} on Red Hat JBoss Web Server 5
...
:URL_INSTALLING_ON_JWS: {URL_BASE_ENTERPRISE}/installing_and_configuring_{URL_COMPONENT_PRODUCT}_on_red_hat_jboss_web_server_5
