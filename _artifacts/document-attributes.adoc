...
:OPTAPLANNER_BOM_VERSION: 8.5.0.Final-redhat-00001
...
:GETTING_STARTED_KOGITO_MICROSERVICES: Getting started with {KOGITO} microservices in {PRODUCT}
...
:PLANNER_QUARKUS_TIMETABLE: {PLANNER} on {QUARKUS}: a school time table quick start guide
:PLANNER_VACCINATION: {PLANNER} on {QUARKUS}: a vaccination appointment scheduler quick start guide
:PLANNER_SPRINGBOOT_TIMETABLE: {PLANNER} on Spring Boot: a school time table quick start guide
